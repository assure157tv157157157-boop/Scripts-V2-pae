-- SpectraSpy V2.0, remastered from TurtleSpy

local colorSettings =
{
    ["Main"] = {
        ["HeaderColor"] = Color3.fromRGB(180, 0, 0), -- Vermelho escuro
        ["HeaderShadingColor"] = Color3.fromRGB(140, 0, 0), -- Vermelho mais escuro
        ["HeaderTextColor"] = Color3.fromRGB(255, 255, 255), -- Branco
        ["MainBackgroundColor"] = Color3.fromRGB(25, 25, 25), -- Preto acinzentado
        ["InfoScrollingFrameBgColor"] = Color3.fromRGB(20, 20, 20), -- Preto mais escuro
        ["ScrollBarImageColor"] = Color3.fromRGB(180, 0, 0) -- Vermelho
    },
    ["RemoteButtons"] = {
        ["BorderColor"] = Color3.fromRGB(180, 0, 0), -- Vermelho
        ["BackgroundColor"] = Color3.fromRGB(35, 35, 35), -- Cinza escuro
        ["TextColor"] = Color3.fromRGB(255, 255, 255), -- Branco
        ["NumberTextColor"] = Color3.fromRGB(220, 220, 220) -- Cinza claro
    },
    ["MainButtons"] = { 
        ["BorderColor"] = Color3.fromRGB(180, 0, 0), -- Vermelho
        ["BackgroundColor"] = Color3.fromRGB(45, 45, 45), -- Cinza médio
        ["TextColor"] = Color3.fromRGB(255, 255, 255) -- Branco
    },
    ['Code'] = {
        ['BackgroundColor'] = Color3.fromRGB(15, 15, 15), -- Preto profundo
        ['TextColor'] = Color3.fromRGB(230, 230, 230), -- Cinza muito claro
        ['CreditsColor'] = Color3.fromRGB(160, 160, 160) -- Cinza médio
    },
    ['Accent'] = {
        ['RedLight'] = Color3.fromRGB(220, 40, 40), -- Vermelho claro
        ['RedDark'] = Color3.fromRGB(100, 0, 0), -- Vermelho muito escuro
        ['GrayLight'] = Color3.fromRGB(200, 200, 200), -- Cinza claro
        ['GrayDark'] = Color3.fromRGB(60, 60, 60) -- Cinza escuro
    }
}
...
if not isfile("SpectraSpySettings.json") then
    writefile("SpectraSpySettings.json", HttpService:JSONEncode(settings))
else
    if HttpService:JSONDecode(readfile("SpectraSpySettings.json"))["Main"] then
        writefile("SpectraSpySettings.json", HttpService:JSONEncode(settings))
    else
        settings = HttpService:JSONDecode(readfile("SpectraSpySettings.json"))
    end
end
...
-- delete the previous instances of spectraspy
if game.CoreGui:FindFirstChild("SpectraSpyGUI") then
    game.CoreGui.SpectraSpyGUI:Destroy()
end
...
local SpectraSpyGUI = Instance.new("ScreenGui")
...
SpectraSpyGUI.Name = "SpectraSpyGUI"

Parent(SpectraSpyGUI)

mainFrame.Name = "mainFrame"
mainFrame.Parent = SpectraSpyGUI
mainFrame.BackgroundColor3 = colorSettings["Main"]["MainBackgroundColor"]
mainFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
BrowserHeader.Parent = SpectraSpyGUI
BrowserHeader.BackgroundColor3 = colorSettings["Main"]["HeaderShadingColor"]
BrowserHeader.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
BrowserHeaderFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
CloseInfoFrame2.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
CloseInfoFrame2.TextColor3 = colorSettings["Main"]["HeaderTextColor"]
...
RemoteBrowserFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
ImageButton.ImageColor3 = colorSettings["Accent"]["RedLight"]
...
mouse.KeyDown:Connect(function(key)
    if key:lower() == settings["Keybind"]:lower() then
        SpectraSpyGUI.Enabled = not SpectraSpyGUI.Enabled
    end
end)
...
Header.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
HeaderShading.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
HeaderTextLabel.Text = "Spectra Spy"
...
RemoteScrollFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
InfoFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
InfoFrameHeader.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
InfoTitleShading.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
CodeFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
Code.Text = "Spectra Spy - Remote Tracking Active"
...
CodeComment.Text = "-- Script generated by SpectraSpy, red themed edition"
...
InfoButtonsScroll.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
FrameDivider.BackgroundColor3 = colorSettings["Accent"]["RedLight"]
FrameDivider.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
CloseInfoFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
OpenInfoFrame.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
Minimize.BorderColor3 = colorSettings["Accent"]["RedDark"]
...
local function ButtonEffect(textlabel, text)
    ...
    textlabel.Text = text
    textlabel.TextColor3 = colorSettings["Accent"]["RedLight"]
    wait(0.8)
...
CopyDecompiled.MouseButton1Click:Connect(function()
    ...
    if not isSynapse() then
        ...
        CopyDecompiled.TextColor3 = colorSettings["Accent"]["RedLight"]
        wait(1.6)
        CopyDecompiled.Text = "Copy decompiled script"
        CopyDecompiled.TextColor3 = colorSettings["MainButtons"]["TextColor"]
        return
...
BlockRemote.MouseButton1Click:Connect(function()
    ...
    if lookingAt and not bRemote then
        ...
        BlockRemote.TextColor3 = colorSettings["Accent"]["RedLight"]
        local remote = table.find(remotes, lookingAt)
        if remote then
            remoteButtons[remote].Parent.RemoteName.TextColor3 = colorSettings["Accent"]["RedLight"]
        end
...
IgnoreRemote.MouseButton1Click:Connect(function()
    ...
    if lookingAt and not iRemote then
        ...
        IgnoreRemote.TextColor3 = colorSettings["Accent"]["GrayDark"]
        local remote = table.find(remotes, lookingAt)
        local unstacked = table.find(unstacked, lookingAt)
        if remote then
            remoteButtons[remote].Parent.RemoteName.TextColor3 = colorSettings["Accent"]["GrayDark"]
        end
...
DoNotStack.MouseButton1Click:Connect(function()
    if lookingAt then
        ...
        if isUnstacked then
            ...
            DoNotStack.TextColor3 = colorSettings["Accent"]["RedLight"]
        end
    end
end)
